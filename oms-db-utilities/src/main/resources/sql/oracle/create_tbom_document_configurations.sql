...
CREATE OR REPLACE TRIGGER omdcn_01t_bir_bur
    ...
    TYPE t_history_rec IS RECORD
                      (
                          ...
                          created_dat     tbom_document_configurations.created_dat%TYPE,
...
BEGIN
    ...
    IF UPDATING THEN
        ...
        IF v_data_changed THEN
            ...
            g_history.EXTEND;
            g_history(g_history.COUNT).footer_id := :OLD.omrda_footer_id;
            g_history(g_history.COUNT).app_doc_spec_id := :OLD.omrda_app_doc_spec_id;
            g_history(g_history.COUNT).code_id := :OLD.omrda_code_id;
            g_history(g_history.COUNT).cfg_value := :OLD.value;
            ...
            FOR i IN 1 .. g_history.COUNT
                LOOP
                    INSERT INTO tbom_document_configurations (
                        ...
                        g_history(i).footer_id,
                        g_history(i).app_doc_spec_id,
                        g_history(i).code_id,
                        g_history(i).cfg_value,
